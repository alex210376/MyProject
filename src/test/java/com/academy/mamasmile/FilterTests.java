...
public class FilterTests extends BaseTest {
    ...
    public void testSlider() throws InterruptedException {
        ...
        WebElement rightBtn = driver.findElement(By.cssSelector("#catalog_price_filter > div > div.noUi-origin.noUi-background > div"));
        WebElement rightInput = driver.findElement(By.id("catalog_price_filter_max_cost"));
        while (getValue(rightInput) > 1000) {
            actions.moveToElement(rightBtn)
                    .clickAndHold()
                    .moveByOffset(-1, 0)
                    .release()
                    .build()
